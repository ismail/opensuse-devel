...
RUN zypper --non-interactive install --no-confirm --no-recommends \
            7zip bmon bsdtar ca-certificates clang14 cpio curl elfutils gcc12 gcc12-c++ gdb go1.18 \
            iproute2 less libc++-devel llvm14 mtr openssl-3 pkgdiff python310 openssh-clients procps \
